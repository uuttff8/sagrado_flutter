...
import 'package:sagrado_flutter/ui/login/chose_place.dart';
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: PlatformText(
                  ...
                  style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, letterSpacing: 1.6),
              ...
              ChoseButton(
                Text(
                  'Выбрать сейчас',
                  style: TextStyle(letterSpacing: 1, color: Colors.blueAccent[700]),
                ),
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => ChosePlaceScreen()));
                },
              ),
              ChoseButton(
                Text(
